    ...
    <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data" accept-charset="UTF-8">
        <div class="row justify-content-center mt-5">
            ...
            <div class="col-lg-7 col-md-8 col-sm-9 col-10 text-center">
                ...
                @else
                    <img id="post_image_preview"  class="img-fluid default_post_image" src="{{ asset('/images/default_post_image-69f9f14784d10ec4rer544rf661e2fc1cb46929c56bd8e6.png') }}" alt="投稿画像未選択">
                @endif
            ...
            <div class="d-md-flex flex-md-column col-lg-5 col-md-8 col-sm-10 col-11 pt-3">
                <div class="form-group">
                    <label for="content" class="col col-form-label"><span class="badge badge-danger mr-1">必須</span>キャプション</label>
                    <textarea id="content" name="content" value="{{ old('content') }}" class="form-control @error('content') is-invalid @enderror" autocomplete="content" placeholder="150字以下で入力してください" rows=8 maxlength="150" autofocus required>{{ old('content') }}</textarea>
                    @error('content')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                        </span>
